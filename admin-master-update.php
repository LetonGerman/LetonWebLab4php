...
<header class="container-fluid">
    <div class="row navbar-dark bg-light justify-content-center">
        ...
        <nav class="nav nav-pills flex-row flex-md-row flex-lg-row flex-xl-row justify-content-right">
            <a class="nav-link flex-sm-fill text-sm-center" href="http://phplab.project17.ru">Main page</a>
        </nav>
    </div>
</header>
...
if(isset($_POST["add"])) {
    ...
    $sql = "INSERT IGNORE INTO articles (headline, text, datePublished) VALUES ('" . $headline . "', '" . $body . "', '" . $now . "')";
